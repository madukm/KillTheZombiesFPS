...
SceneZero::SceneZero(Shader* shader)
{
	...
	//---------- Obstacles ----------//
	// Corner Obstacles
	_blocks.push_back(new Block(shader, glm::vec3(-30,2,40), glm::vec3(0,0,0), glm::vec3(2,4,2), glm::vec3(0.1,0.1,0.8)));
	_blocks.push_back(new Block(shader, glm::vec3(30,2,40), glm::vec3(0,0,0), glm::vec3(2,4,2), glm::vec3(0.1,0.1,0.8)));

	_blocks.push_back(new Block(shader, glm::vec3(-30,2,-40), glm::vec3(0,0,0), glm::vec3(2,4,2), glm::vec3(0.1,0.8,0.2)));
	_blocks.push_back(new Block(shader, glm::vec3(30,2,-40), glm::vec3(0,0,0), glm::vec3(2,4,2), glm::vec3(0.1,0.8,0.2)));

	// Middle line
	_blocks.push_back(new Block(shader, glm::vec3(0,2,0), glm::vec3(0,0,0), glm::vec3(2,4,2), glm::vec3(0.1,0.6,0.8)));

	// Vertical obstacles
	_blocks.push_back(new Block(shader, glm::vec3(-20,2,25), glm::vec3(0,90,0), glm::vec3(2,4,2), glm::vec3(0.1,0.1,0.8)));
	_blocks.push_back(new Block(shader, glm::vec3(20,2,25), glm::vec3(0,90,0), glm::vec3(2,4,2), glm::vec3(0.1,0.1,0.8)));
	_blocks.push_back(new Block(shader, glm::vec3(-20,2,-25), glm::vec3(0,90,0), glm::vec3(2,4,2), glm::vec3(0.1,0.8,0.1)));
	_blocks.push_back(new Block(shader, glm::vec3(20,2,-25), glm::vec3(0,90,0), glm::vec3(2,4,2), glm::vec3(0.1,0.8,0.1)));
}
